...
Funcionalidade: Relatório de Bug e Suporte ao Cliente
  ...
  Cenário: Submeter um relatório de bug com anexo
    ...
    E clico no botão button[data-testid="submit-bug-report"]
    Então vejo a mensagem ".alert-success" com "Bug reportado com sucesso!"
    E o relatório de bug deve ter "screenshot_mobile.png" como anexo

  Cenário: Tentar submeter com título muito curto
    Dado que estou na página de "Relatar Bug" em "https://app.suporte.com/bugs/novo"
    Quando preencho o campo input[name="titulo-bug"] com "Bug"
    E preencho o campo textarea[name="descricao-bug"] com "Uma descrição válida para o bug."
    E preencho o campo textarea[name="passos-reproducao"] com "Passos para reprodução."
    E clico no botão button[data-testid="submit-bug-report"]
    Então vejo a mensagem ".error-msg[for='titulo-bug']" com "Título deve ter no mínimo 10 caracteres."
    E não sou redirecionado da URL "https://app.suporte.com/bugs/novo"

  Cenário: Cancelar a criação de um relatório de bug
    Dado que estou na página de "Relatar Bug" em "https://app.suporte.com/bugs/novo"
    Quando preencho o campo input[name="titulo-bug"] com "Rascunho de Bug"
    E clico no botão button[data-testid="cancelar-bug-report"]
    Então sou redirecionado para a URL "https://app.suporte.com/dashboard"
    E a URL "https://app.suporte.com/bugs/novo" não deve ser acessível

  Cenário: Submeter relatório de bug com campos opcionais preenchidos
    Dado que estou na página de "Relatar Bug" em "https://app.suporte.com/bugs/novo"
    Quando preencho o campo input[name="titulo-bug"] com "Problema de cache na página de produtos"
    E preencho o campo textarea[name="descricao-bug"] com "Produtos antigos aparecem após atualização do estoque."
    E preencho o campo textarea[name="passos-reproducao"] com "1. Atualizar estoque. 2. Acessar /produtos."
    E preencho o campo input[name="resultado-esperado"] com "Ver novos produtos."
    E preencho o campo input[name="resultado-real"] com "Ver produtos antigos."
    E preencho o campo input[name="ambiente"] com "Chrome 120, Windows 11"
    E preencho o campo input[name="tags"] com "cache, frontend, estoque"
    E clico no botão button[data-testid="submit-bug-report"]
    Então vejo a mensagem ".alert-success" com "Bug reportado com sucesso!"
    E o relatório de bug deve ter a tag "cache"